...
def main():
    ...
    pretrained_path = "results/lstm_ae/general/best_model.pth"
    save_dir = f"results/lstm_ae/personalized/{participant}"
    ...
    plt.legend()
    plt.savefig(f'results/lstm_ae/personalized/{participant}/losses.png')
    plt.close()
