...
def main():
    ...
    if args.model_path is None:
        if args.model_type == "pure":
            args.model_path = f"results/tcn_ae/pure/{args.participant}/final_model_{args.participant}.pth"
        elif args.model_type == "personalized":
            args.model_path = f"results/tcn_ae/personalized/{args.participant}/best_model.pth"
        else:  # general
            if args.model_dir is None:
                args.model_dir = "results/tcn_ae/general"
            args.model_path = f"{args.model_dir}/final_model.pth"
    
    if args.figs_dir is None:
        if args.model_type == "pure":
            args.figs_dir = f"results/tcn_ae/pure/{args.participant}/figs"
        elif args.model_type == "personalized":
            args.figs_dir = f"results/tcn_ae/personalized/{args.participant}/figs"
        else:  # general
            if args.model_dir is None:
                args.model_dir = "results/tcn_ae/general"
    ...
    config_path = "config/tcn_config.json"
