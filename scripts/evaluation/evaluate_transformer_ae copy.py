...
def main():
    ...
    if args.model_type in ["pure", "personalized"]:
        if args.participant is None:
            parser.error("--participant is required for pure or personalized models")
        if args.participants is not None:
            print("Warning: --participants ignored for pure or personalized models")
    else:  # general
    ...
    if args.model_type in ["pure", "personalized"]:
        # Per-participant model evaluation (pure or personalized)
